...
<p>
Structured, customizable, and managed memory for agency economics.</p>
...
<CardGroup>
  ...
  <Card title="Examples" icon="lightbulb-cfl-on" color="https://docs.memorymodel.dev/examples/agent-integration-examples">
